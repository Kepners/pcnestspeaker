...
// Validate license key format: XXXX-XXXX-XXXX-XXXX (16 uppercase hex chars)
// Generated by website HMAC: first 16 chars of SHA256 HMAC
function validateLicenseFormat(key) {
  if (!key) return false;
  const cleanKey = key.toUpperCase().trim();
  // Format: XXXX-XXXX-XXXX-XXXX (19 chars with dashes, 16 hex chars)
